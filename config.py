...
MUMBLE_BANDWIDTH = int(os.getenv("MUMBLE_BANDWIDTH", "64000"))
...
RECOMMENDER_ITUNES_LIMIT = int(os.getenv("RECOMMENDER_ITUNES_LIMIT", "10"))
RECOMMENDER_ITUNES_TIMEOUT = int(os.getenv("RECOMMENDER_ITUNES_TIMEOUT", "5"))
# QoL/robustness tuning (all optional, sane defaults):
RECOMMENDER_VERIFY = os.getenv("RECOMMENDER_VERIFY", "True").lower() == "true"
RECOMMENDER_SCORE_THRESHOLD = float(os.getenv("RECOMMENDER_SCORE_THRESHOLD", "0.35"))
RECOMMENDER_ARTIST_COOLDOWN = int(os.getenv("RECOMMENDER_ARTIST_COOLDOWN", "8"))
RECOMMENDER_CACHE_TTL = int(os.getenv("RECOMMENDER_CACHE_TTL", "86400"))
RECOMMENDER_MAX_CANDIDATES_VERIFY = int(os.getenv("RECOMMENDER_MAX_CANDIDATES_VERIFY", "8"))
RECOMMENDER_CANDIDATES = int(os.getenv("RECOMMENDER_CANDIDATES", "8"))
RECOMMENDER_MAX_TOKENS = int(os.getenv("RECOMMENDER_MAX_TOKENS", "500"))
RECOMMENDER_RETRY = os.getenv("RECOMMENDER_RETRY", "True").lower() == "true"
